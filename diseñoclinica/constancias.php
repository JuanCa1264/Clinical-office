...
<body>
    ...
    <div class="container">
         ...
         <div class="form-group">
            ...
            <input type="text" name="paciente" id="paciente" class="form-control" placeholder="Nombre Del Paciente" required>
            <br>
            <label for="padecimiento">padecimiento: </label>
            <input type="text" name="padecimiento" id="Padecimiento" class="form-control" placeholder="Padecimiento" required>
            <label for="Fecha">Fecha: </label>
            <input type="date" name=" fecha" id="Fecha" class="form-control" required>
            <label for="incapacidad">Dias De Incapacidad: </label>
            <input type="text" name="incapacidad" id="incapacidad" class="form-control" placeholder="Dias De Incapacidad" required>
