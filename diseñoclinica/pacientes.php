...
<?php
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            if ($res) {
                echo '<script>
swal({
    title: "!Paciente agredado exitosamente!",
    text: "Se ha registrado al paciente",
    icon: "success"
}).then(function() {
  ...
  echo 'setTimeout(function () { swal("No se agregó el paciente", "Revise nuevamente los datos del formulario","error");';
  echo '}, 500);</script>';
