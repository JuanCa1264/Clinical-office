...
<?php
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $HoraI  = $usuario->sanitize($_POST['Hora_Ini']);
            $HoraF = $usuario->sanitize($_POST['Hora_Fin']);
            $Dis = $_POST['Dia'];
            $Day = utf8_decode($Dis);
            ...
            while (($row = mysqli_fetch_array($result)) != NULL) {
                echo $row["Id_Doctor"].$row["Nombre_Doctor"]." ".$row["Apellido_Doctor"];
                $id = $row['Id_Doctor'];
                 ...
                 $res = $usuario->createHorario($id, $Day, $HoraI,$HoraF);
...
swal({
    ...
    text: "Se registro el horario indicado",
    icon: "success"
}).then(function() {
  ...
  echo 'setTimeout(function () { swal("No se agrego el horario", "Verifique que el horario está en un formato válido","error");';
  echo '}, 500);</script>';
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="index_doctor.php"><i class="fa fa-fw fa-user-circle"></i>Inicio<span class="badge badge-success"></span></a>
                                  ...
                                  <li class="nav-item ">
                                <a class="nav-link active" href="HorarioRead.php"><i class="fa fa-fw fa-user-circle"></i>Ver mi horario<span class="badge badge-success"></span></a>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Gestión de horario</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="time" name="Hora_Ini" id="fecha_i" class="form-control" required>
                </div>
            </div>
<br>
            <div class="col">
                 <label for="Hora">Hora fin: </label>
                 <input type="time" name="Hora_Fin" id="fecha_f" class="form-control" required>
