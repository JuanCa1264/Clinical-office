        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $Day = utf8_decode($Dis);
             ...
             $conexion = mysqli_connect("localhost","root","","consultorioclinico") or die ("Error en la conexión con la Base de Datos");
                 ...
                 $res = $usuario->updateHorario($Day, $HoraI,$HoraF,$id);
...
swal({
    ...
    text: "Se ha modificado el horario indicado",
    icon: "success"
}).then(function() {
  ...
  echo 'setTimeout(function () { swal("No se modificó el horario", "Verifique que el horario está en un formato válido","error");';
  echo '}, 500);</script>';
        ...
        $datos_usuario = $usuario->single_record_Horario($id);
    ...
    <div class="container">
         ...
         <div class="form-group">
            ...
            <select name="Dia" class="form-control">
                 <option><?php echo $datos_usuario->Dia;?></option>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="time" name="Hora_Ini" id="fecha_i" class="form-control" value="<?php echo $datos_usuario->Hora_Ini;?>">
                </div>
            </div>
<br>
            <div class="col">
                 <label for="Hora">Hora fin: </label>
                 <input type="time" name="Hora_Fin" id="fecha_f" class="form-control" value="<?php echo $datos_usuario->Hora_Fin;?>">
