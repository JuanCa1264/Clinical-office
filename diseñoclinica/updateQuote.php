...
swal({
    ...
    text: "Se guardaron los cambios de la cita",
    icon: "success"
}).then(function() {
  ...
  echo 'setTimeout(function () { swal("Error al modificar", "Revise nuevamente los datos y el horario del doctor","error");';
  echo '}, 100);</script>';
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="date" name=" Fecha" id="fecha" class="form-control" value="<?php echo $datos_usuario->Fecha_Cita; ?>" min= '<?php 
                    $fecha = date('Y-m-d');
                    echo $fecha;
                    ?>' onchange = "diaSemana();">
