...
<?php
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $res = $usuario->UpdateConsulta($Motivo_Consulta, $Sintomas, $Padecimiento, $Examenes, $idC);

            if ($res) {
                
                 echo '<script>
swal({
    title: "¡Diágnostico modificado exitosamente!",
    text: "Se registraron los nuevos datos de la consulta ",
    icon: "success"
}).then(function() {
  ...
  echo 'setTimeout(function () { swal("No modifico el diágnostico", "Revise nuevamente los datos del formulario","error");';
  echo '}, 500);</script>';
        ...
        $datos_usuario = $usuario->single_record_Consulta($idC);
...
<body>
    ...
    <div class="container">
        ...
        <input type="text" name=" consulta" id="consulta" class="form-control" W title="Coloca el motivo de la conslta del paciente" maxlength="6" placeholder="Ej. Fiebre" value="<?php echo $datos_usuario->Motivo_Consulta;?>">
                </div>
            </div>


            <label for="sintomas">Sintomas: </label>
            <textarea id="sintomas" placeholder="Escriba Los Sintomas Indicados Por El Paciente" class="form-control" name="Sintomas"><?php echo $datos_usuario->Sintomas;?></textarea>


<label for="Padecimiento">Padecimiento: </label>
<input type="text" name="Padecimiento" id="padecimiento" class="form-control" value="<?php echo $datos_usuario->Padecimiento;?>">
<label for="Sintomas">Examenes: </label>
            <textarea id="examenes" placeholder="Escriba Los Examenes Indicados para el paciente" class="form-control" name="Examenes"><?php echo $datos_usuario->Examenes;?></textarea>
